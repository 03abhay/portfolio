...
import { TrendingUp, CloudRain, Twitter, Search, ExternalLink } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            <Reveal key={idx} delay={idx * 100}>
              <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 dark:border-slate-800 group h-full hover:-translate-y-2 hover:border-primary/30">
                <div className="p-8">
